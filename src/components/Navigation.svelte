...
<div class="navigation-container relative h-full flex flex-col">
    ...
    >
        <div class="flex justify-center items-center w-full space-x-3">
            {#if $vault.address}
                <div
                    class="cursor-pointer absolute right-2 top-2 z-10"
                    on:click={() => {
                        if (!$sftInfo) {
                            showSftInfo();
                        } else hideSftInfo();
                ...
                >
                    ...
                    >
                        <path
                            d="M14 10.3999L19 5.1999M19 5.1999L19 10.3999M19 5.1999L14 5.1999"
                            stroke="#9D9D9D"
                            stroke-width="2"
                        ...
                        />
                        <path
                            d="M10 14.5601L5 19.7601M5 19.7601L5 14.5601M5 19.7601H10"
                            stroke="#9D9D9D"
                            stroke-width="2"
                            stroke-linecap="round"
                            stroke-linejoin="round"
            ...
            {#if $vault && $vault.address}
                ...
                {#if $accountRoles.DEPOSITOR}
                    <NavigationButton
                        ...
                        {path}
                        child={true}
                        on:navClick={handleMintClick}
                    />
                    <NavigationButton
                        targetPath="#asset-classes"
                        {path}
                        child={true}
                        on:navClick={handleClick}
                    />
                ...
                />
                <NavigationButton
                    targetPath="#audit-history"
                    {path}
                    child={true}
                    on:navClick={handleClick}
                />
                <NavigationButton
                    targetPath="#asset-register"
                    {path}
                    child={true}
                    on:navClick={handleClick}
                />
...
>>>>>>> main
            ...
            <NavigationButton
                ...
                {path}
                externalUrl="https://gildlab.document360.io/"
            >
                <div slot="icon">
                    <svg
                        width="24"
    ...
    {#if $sftInfo}
        <div
            class="bg-white w-[22rem] ml-[12.7rem] fixed mt-[103px] bg-opacity-70 backdrop-blur-md rounded-r-lg pt-6 border-l sft-info"
        >
            <div
                class="cursor-pointer absolute right-2 top-2"
                on:click={() => hideSftInfo()}
            >
                <svg
                    width="25"
                    height="24"
                ...
                >
                    <path
                        d="M5.96387 5L10.9731 10M10.9731 10V5M10.9731 10H5.96387"
                        stroke="#9D9D9D"
                        stroke-width="2"
                        stroke-linecap="round"
                        stroke-linejoin="round"
                    ...
                    />
                    <path
                        d="M19.9902 19L14.981 14M14.981 14L14.981 19M14.981 14L19.9902 14"
                        stroke="#9D9D9D"
                        stroke-width="2"
                        stroke-linecap="round"
                        stroke-linejoin="round"
