<script>
    ...
    function viewContract(address) {
        window.open(`${$activeNetwork.blockExplorer}/address/${address}`);
    }
...
<path
  d="M15.5834 4.88685V7.86185C15.5834 10.341 14.5917 11.3327 12.1126 11.3327H11.3334V9.13685C11.3334 6.65768 10.3417 5.66602 7.86258 5.66602H5.66675V4.88685C5.66675 2.40768 6.65841 1.41602 9.13758 1.41602H12.1126C14.5917 1.41602 15.5834 2.40768 15.5834 4.88685Z"
  stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
          </span>
        </div>
