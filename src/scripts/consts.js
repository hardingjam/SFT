...
export const TEST_CONTRACT_ADDRESS =
    "0x1cf0ab6cf30a8aea01e82cd6d831845fec4363a3";
...
export const TRANSACTION_IN_PROGRESS_TEXT =
    "Transaction taking place, please wait.";
...
export const ROUTE_LABEL_MAP = new Map([
    ...
    ["#receipt/:id", "Receipt"],
    ["#sft-create-success", "SFT Created ccessfully"],
    ["#ipfs", "IPFS"],
    ["#manual", "Manual"],
